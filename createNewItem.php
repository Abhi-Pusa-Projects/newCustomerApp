  <?php
        ...
        try {
          ...
          $sql="INSERT INTO items(itemName,itemPrice,itemDesc,itemQuantity,itemType,itemStockQuan,itemBuyPrice,itemSellPrice)
                VALUES (:itemName,:itemPrice,:itemDesc,:itemQuantity,:itemType,:itemStockQuan,:itemBuyPrice,:itemSellPrice)";
          ...
          if($result){
            ...
            deliver_response(200,"data inserted",true);
          }
          else{
            //if data is not inserted will return unsuccessful message to database
            deliver_response(200,"data not inserted",false);
          }
